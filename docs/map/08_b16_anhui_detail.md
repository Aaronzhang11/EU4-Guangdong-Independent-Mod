...
| 区域 | 省份 | 数量 | 区域发展度 | 主要玩法 |
|---|---|---:|---:|---|
| 淮颍 | 亳州、颍州、寿州、凤阳 | 4 | 42 | 淮北农业、寿春要塞、淮河商路 |
| 江淮 | 六安、庐州、巢湖、滁州、和州 | 5 | 43 | 大别山东口、巢湖水运、南京西屏 |
...
- 颍州—寿州、凤阳—和州和凤阳—滁州通过淮河隐藏海峡邻接过河，保留直接通行和
  海峡渡口战斗惩罚。
...
当前新增编号为 `5058–5068`；既有安庆、庐州、凤阳、颍州、宁国、徽州沿用原编号。
