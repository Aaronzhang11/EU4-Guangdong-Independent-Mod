...
GIVEN_NAME_SETS_BASE: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "khitan": {
        "male": (
            "阿保机", "德光", "倍", "李胡", "阮", "璟", "贤", "隆绪",
            "宗真", "洪基", "延禧", "大石", "曷鲁", "屋质", "休哥", "斜轸",
            "察割", "安端", "罨撒葛", "只没", "重元", "仁先", "挞烈", "敌鲁",
            "迭剌", "涅里", "撒剌的", "雅里",
        ),
        "female": (
            "平", "绰", "观音", "菩萨哥", "耨斤", "塔不烟",
    ...
    "qiongli": {
        "male": (
            "南蛇", "亚贵", "亚根", "亚龙", "阿郎", "阿峒", "那任", "那斗",
            "多文", "保显", "番兴", "昌盛", "罗活", "劳旺", "美孚", "润黎",
        ),
        "female": (
            "亚妹", "阿妹", "那燕", "美娘", "玉妹", "金花",
            "银花", "娥娘", "兰妹", "亚兰", "阿玉", "美燕",
...
NAME_COMPONENTS: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "khitan": {
        ...
        "male_right": (
            "保机", "鲁", "质", "哥", "轸", "割", "里", "剌", "烈", "石",
            "撒葛", "没", "先", "古", "安", "奴", "不", "迭", "宁", "荣",
        ),
        "female_left": (
            "阿", "燕", "观", "菩萨", "耨", "塔", "普速", "奥", "骨", "撒葛", "霞", "特",
        ),
        "female_right": (
            "平", "燕", "音", "哥", "斤", "烟", "完", "野", "欲", "只", "抹", "里",
        ),
    },
    "oirat": {
        "male_left": (
...
CULTURE_SPECS: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "gdd_khitan": ("khitan", ("耶律", "萧", "述律", "拔里", "乙室己", "遥辇", "世里", "乌隗", "迷里吉", "仆隗", "蔑古乃", "瓯昆", "李", "孙")),
    ...
    # The Li originally used few surnames; Wang and Fu are documented early
