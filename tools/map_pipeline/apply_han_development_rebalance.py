...
DEVELOPMENT = {
    "Jiangxi": {
        670: (4, 4, 2), 683: (4, 4, 2), 1833: (7, 7, 5),
        2151: (4, 4, 2), 4979: (7, 8, 5), 4980: (6, 7, 4),
        4992: (5, 5, 4), 4993: (3, 3, 2), 4994: (2, 2, 2),
        4995: (3, 3, 2), 5323: (3, 3, 2), 5324: (2, 3, 2),
        5325: (3, 5, 2), 5326: (2, 3, 1), 5327: (2, 3, 3),
        5328: (1, 2, 1),
    },
    "Hunan": {
        671: (4, 4, 2), 672: (5, 6, 4), 2173: (1, 1, 1),
        2174: (2, 2, 2), 4982: (7, 8, 4), 4983: (3, 3, 4),
        4996: (1, 2, 1), 4997: (2, 2, 2), 4998: (4, 5, 3),
        4999: (2, 2, 3), 5000: (3, 3, 4), 5001: (4, 6, 4),
        5312: (1, 1, 1), 5313: (0, 1, 2), 5314: (1, 1, 2),
        5315: (1, 1, 2), 5316: (1, 1, 1), 5317: (0, 1, 2),
        5318: (1, 1, 2), 5319: (1, 1, 1), 5320: (3, 2, 1),
        5321: (1, 3, 1), 5322: (2, 2, 2),
    },
    "Hubei": {
...
REGISTRY_RETAINED = {
    670: (4, 4, 2), 683: (4, 4, 2), 1833: (7, 7, 5), 2151: (4, 4, 2),
    671: (4, 4, 2), 672: (5, 6, 4), 2173: (1, 1, 1), 2174: (2, 2, 2),
    681: (4, 4, 3), 682: (6, 7, 4), 2171: (6, 6, 5),
